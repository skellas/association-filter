...
--
DELETE FROM alf_applied_patch WHERE id = 'patch.db-V5.0-AssociationFilterViewsUpgrade';
INSERT INTO alf_applied_patch
(id, description, fixes_from_schema, fixes_to_schema, applied_to_schema, target_schema, applied_on_date, applied_to_server, was_executed, succeeded, report)
VALUES
	(
		'patch.db-V5.0-AssociationFilterViewsUpgrade', 'Manually executed script for V5.0: Create Association Filter Database Views',
